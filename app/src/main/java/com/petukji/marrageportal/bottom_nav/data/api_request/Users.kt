...
//        })
    ...
    fun getUserData() {
        ...
        call.enqueue(object : Callback<UsersProfileList> {
            override fun onResponse(
                call: Call<UsersProfileList>,
                response: Response<UsersProfileList>
            ) {
                if (response.isSuccessful) {
            ...
            override fun onFailure(call: Call<UsersProfileList>, t: Throwable) {
